    ...
    <div class="modal fade" id="addPlayerModal" tabindex="-1" aria-labelledby="addPlayerModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="addPlayerModalLabel">Ajouter un nouvel avis</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="addPlayerForm">
                    <div class="mb-3">
                        <label for="playerPseudo" class="form-label">Jeu</label>
                    ...
                    <div class="mb-3">
                        <label for="playerPseudo" class="form-label">Note</label>
                        <input type="text" class="form-control" id="playerPseudo" required>
                    </div>
                    <div class="mb-3">
                        <label for="playerPseudo" class="form-label">Commentaire</label>
                        <input type="text" class="form-control" id="playerPseudo" required>
                    </div>
                </form>
            </div>
